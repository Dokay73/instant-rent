  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 flex items-center gap-5">
        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#4A6CF7] to-[#8B5CF6] flex items-center justify-center text-white text-xl font-bold shadow-md">
          {initials}
        </div>
        <div>
      ...
      <form onSubmit={handleSave} className="space-y-5">
        <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
          <h2 className="text-sm font-semibold text-slate-900 pb-2 border-b border-slate-100">Informations générales</h2>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6">
          <h2 className="text-sm font-semibold text-slate-900 mb-3 pb-2 border-b border-slate-100">Présentation</h2>
